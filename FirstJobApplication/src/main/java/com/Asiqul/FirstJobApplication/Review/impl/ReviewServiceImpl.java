package com.Asiqul.FirstJobApplication.Review.impl;
...
import com.Asiqul.FirstJobApplication.Review.ReviewRepository;
import com.Asiqul.FirstJobApplication.Review.ReviewService;
...
public class ReviewServiceImpl implements ReviewService {
    ...
    @Override
    public Review getReview(Long companyId, Review reviewId) {
        List<Review> reviews = reviewRepository.findByCompanyId(companyId);
